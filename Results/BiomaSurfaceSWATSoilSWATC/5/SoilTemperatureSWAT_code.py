def Init(states_LayerThickness):
    ...
    Initializes soil temperature for each layer to 15 degC.
...
def Estimate(LagCoefficient,
    ...
    Inputs:
    - LagCoefficient: float, lag coefficient controlling influence of previous day's temperature [0-1]
    ...
    - states_SoilTemperatureByLayers: list of previous day's soil temperatures by layer [degC]
    - states_BulkDensity: list of bulk density by layer [t m-3]
    - states_VolumetricWaterContent: list of volumetric water content by layer [m3 m-3]
    - states_LayerThickness: list of soil layer thicknesses [m]

    Returns:
    - states_SoilTemperatureByLayers: list of updated soil temperatures by layer [degC]
    """
    import math
