def Init(exogenous_meanAnnualAirTemp: float) -> float:
    ...
    Returns:
    - deeplayerstates_deepLayerT: float (°C) initialized deep layer temperature
    """
...
def Estimate(
    ...
    - exogenous_maxTAir: float (°C) maximum air temperature
    - exogenous_meanTAir: float (°C) mean air temperature
    - exogenous_minTAir: float (°C) minimum air temperature
    ...
    - states_maxTSoil: float (°C) maximum soil temperature
    - states_minTSoil: float (°C) minimum soil temperature
    """
