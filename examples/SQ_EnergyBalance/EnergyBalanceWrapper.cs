...
namespace Model.Model.EnergyBalance
{
    class EnergyBalanceWrapper :  UniverseLink
    {
        ...
        public void EstimateEnergyBalance(double minTair, double maxTair, double solarRadiation, double vaporPressure, double extraSolarRadiation, double hslope, double conductance, double deficitOnTopLayers, double VPDair, double netOutGoingLongWaveRadiation)
        {
            a.minTair = minTair;
            a.maxTair = maxTair;
